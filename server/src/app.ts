...
import campaignCreatorRoutes from './routes/campaignCreators';
...
app.use('/api/campaign-creators', campaignCreatorRoutes);
...
app.use('/api/campaign-creators/:id/workflow', workflowRoutes);
